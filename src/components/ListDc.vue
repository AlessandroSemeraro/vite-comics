...
<script>
import albumDCElement from './AlbumDCElement.vue'
export default {
    name: 'listDc',
    data() {
        return {
...
<template >
    <section class="container-dc">
        <albumDCElement v-for="albumDC in ListDc"
        :thumbSrcDc="albumDC.thumb" 
        :priceDc="albumDC.price"
        :seriesDc="albumDC.series"
        :typeDc="albumDC.type"
        />
    </section>
</template>
